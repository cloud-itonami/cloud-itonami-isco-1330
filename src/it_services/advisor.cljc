(ns it-services.advisor
  "ITServicesAdvisor — proposes an IT-services-management operation
  (deploy support, run a monitoring check, power-cycle a data center,
  migrate client data) for a registered client. The advisor is
  ...
  and has no notion of client provenance or power-cycle/data-migration
  risk; `it-services.governor` is the independent system that decides
  whether the proposal may proceed, per the itonami actor pattern.

  A proposal is a map:
    {:op :deploy-support|:monitor|:power-cycle-datacenter|:migrate-client-data
...
(def ^:private system-prompt
  "You are an IT-services-management advisor. Given an IT operation
